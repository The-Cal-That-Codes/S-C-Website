  ...
  return (
    <FooterStyles>
      ...
      <div className="flex">
        {Logo ? (
          <div className="brand-cont">
            ...
            <span className="privacy" role="button" tabIndex={0} onClick={()=> setshowPrivacy(!showPrivacy)} onKeyDown={()=> setshowPrivacy(!showPrivacy)}>Privacy Policy</span>
      ...
      :<div className="privacyContainer">
        <Button label="Back" cta="Back" className="backButton" onClick={()=> setshowPrivacy(!showPrivacy)} onKeyDown={()=> setshowPrivacy(!showPrivacy)}/>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Croft Digital, 63 Christmas St.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to CroftDigital, accessible from <a href="http://www.CroftDigital.com" rel="noreferrer" target="_blank">http://www.CroftDigital.com</a></p>
</li>
<li>
...
<ul>
<li>By email: CroftDigital@gmail.com</li>
</ul>
