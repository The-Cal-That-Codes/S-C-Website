  ...
  return (
    <FooterStyles>
      ...
      <div className="flex">
        {Logo ? (
          <div className="brand-cont">
            ...
            <p className="privacy" onClick={()=> setshowPrivacy(!showPrivacy)}>Privacy Policy</p>
      ...
      :<div className="privacyContainer">
        <Button label="Back" cta="Back" className="backButton" onClick={()=> setshowPrivacy(!showPrivacy)}/>
...
<li>
<p><strong>Website</strong> refers to CroftDigital, accessible from <a href="http://www.CroftDigital.com" rel="external nofollow noopener" target="_blank">http://www.CroftDigital.com</a></p>
</li>
<li>
