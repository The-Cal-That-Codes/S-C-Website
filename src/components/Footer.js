...
import { mainMenuItems, footerMenuItems } from "../constants/menu-items"
          ...
          <div className="flex">
            ...
            <div className="copy-cont">
              <ul className="copy">
                ...
                {footerData.author && <li>{footerData.author}</li>}
              </ul>
            </div>
          </div>
        </div>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Croft Digital, 63 Christmas St.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to CroftDigital, accessible from{" "}
                <a
                  href="http://www.CroftDigital.com"
                  rel="noreferrer"
                  target="_blank"
                >
                  http://www.CroftDigital.com
                </a>
              </p>
            </li>
            <li>
